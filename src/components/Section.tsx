...
export default function Section(props: { sectionName: string, showImg: boolean, children?: JSX.Element | JSX.Element[] }) {
    return (
        <div className={classes.row}>
            <div className={classes['work__box']}>
                ...
                {props.showImg && <div className={classes['work__image-box']}>
